...
package com.sysu.goals.bookmanage.scanner.decode;
...
import com.sysu.goals.bookmanage.scanner.view.ViewfinderResultPointCallback;
	...
	public void handleMessage(Message message) {
		switch (message.what) {
			...
			case R.id.decode_succeeded:
				...
				String ISBN=activity.handleDecode((Result) message.obj, barcode,
						scaleFactor);
				try {
					//wait
					Thread.sleep(2000);
